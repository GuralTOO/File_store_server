...
def get_answer(query: str, path: str):
    ...
    for filePath in contexts.keys():
        ...
        for context in contexts[filePath]:
...
# result = get_answer_stream(question="Give some text from the second page of each paper. Do not make any assumptions.", path="84077a0c-0b0f-43f5-96a5-5c517d1c6d13/Folder X")
# for part in result:
#     print(part, end="")
# print(get_answer(query="Extract the primary authors of all the papers as shown in the first page of each paper. Do not make any assumptions.", path="84077a0c-0b0f-43f5-96a5-5c517d1c6d13/Folder X"))